...
class Product:
   ...
   def __init__(self, Window):
      ...
      frame = LabelFrame(self.wind, text = "Register A new Product", font = ("Tahoma", 12),bg = "blue", width = "60")
      ...
      #Button Add Product
      ttk.Button(frame, text = "Save Preduct", command = self.add_product).grid(row = 3, columnspan = 2, sticky = W + E)
   ...
   def add_product(self):
      if self.validation():
         ...
         self.messages["text"] = "Name and Price are Requried"
      self.get_products()   
